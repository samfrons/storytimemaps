...
const ChartSkeleton = ({ height = '400px' }: { height?: string }) => (
  <div
    ...
    style={{ height, backgroundColor: 'var(--card-bg)', border: '1px solid var(--border)' }}
  >
    Loading chart...
  </div>
)

// Dynamically import 3D map to avoid SSR issues and improve performance
const District3DMap = dynamic(() => import('./components/District3DMap'), {
  ssr: false,
  loading: () => <ChartSkeleton height="700px" />,
})

// Dynamically import chart components for code splitting
const MonthlyDestructionChart = dynamic(() => import('./components/MonthlyDestructionChart'), {
  ssr: false,
  loading: () => <ChartSkeleton height="400px" />,
})

const YearlyDestructionChart = dynamic(() => import('./components/YearlyDestructionChart'), {
  ssr: false,
  loading: () => <ChartSkeleton height="400px" />,
})
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-6 md:pl-20">
          <h1 className="text-2xl md:text-3xl font-bold font-mono mb-2">{t('barcharts.title')}</h1>
          <p
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-12 md:pl-20">
        ...
        <section>
          ...
          <ErrorBoundary componentName="3D Map">
        ...
        <section>
          ...
          <div className="mb-8">
            <ErrorBoundary componentName="Yearly Chart">
          ...
          {/* Monthly Chart - Below */}
          <div>
            <ErrorBoundary componentName="Monthly Chart">
