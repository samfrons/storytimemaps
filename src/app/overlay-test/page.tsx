  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#4a4a57]">
      ...
      <div className="flex flex-col md:flex-row h-screen">
        ...
        <div
          className="hidden md:flex md:w-16 md:h-full flex-shrink-0 flex-col items-center py-6 gap-4 relative backdrop-blur-sm"
          style={{
            zIndex: 10000,
        ...
        >
          ...
          <button
            ...
            style={{
              backgroundColor: showThemeMenu
                ? 'var(--primary)'
                : 'var(--input-bg, rgba(var(--muted-rgb), 0.5))',
          ...
          {showThemeMenu && (
            <div
              className="absolute top-16 left-0 border backdrop-blur-sm shadow-lg p-2 min-w-[120px]"
              style={{
                zIndex: 10001,
            ...
            >
              {['moody', 'bauhaus', 'cool', 'warm', 'hot', 'cold', 'art-nouveau'].map(
                (themeName) => (
                  <button
                    key={themeName}
                    onClick={() => {
      ...
      {showMobileMenu && !showIntro && (
        <div
          className="md:hidden fixed top-16 left-4 border backdrop-blur-sm shadow-lg p-2 flex flex-col gap-2"
          style={{
            zIndex: 10001,
            backgroundColor: 'var(--dropdown-bg, var(--input-bg, rgba(var(--muted-rgb), 0.9)))',
            borderColor: 'var(--border)',
      ...
      {showThemeMenu && showMobileMenu && !showIntro && (
        <div
          className="md:hidden fixed top-16 left-20 shadow-lg p-2 min-w-[120px] border"
          style={{
            zIndex: 10002,
            backgroundColor: 'var(--dropdown-bg, var(--input-bg, rgba(var(--muted-rgb), 0.9)))',
            borderColor: 'var(--border)',
      ...
      >
        ...
        <div
          className="relative min-h-full flex items-center justify-center px-4 sm:px-6 md:px-8"
          style={{
        ...
        >
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div className="relative space-y-8">
              <div>
                <h1
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light mb-4 font-['Space_Mono'] font-mono"
                  style={{ color: 'var(--foreground)' }}
                >
                  Jewish Businesses
                </h1>
                <p
                  className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light font-['Space_Mono'] font-mono"
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                <p
                  ...
                  style={{ color: 'var(--foreground)' }}
                >
                  Explore the stories of over 8,000 Jewish-owned businesses that once formed the
                  backbone of Berlin&apos;s commercial life.
                </p>
                <p
              ...
              >
                <div>
                  ...
                  <p className="leading-relaxed">
                    Between 1900 and 1945, Jewish entrepreneurs operated thousands of businesses in
                    Berlin, from small shops to major department stores. This map documents their
                    locations, types, and fates during the Nazi era.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    historical directories, registration documents, and survivor testimonies. Each
                    entry represents not just a business, but a family&apos;s livelihood and
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    Use the timeline controls to see how the business landscape changed over 45
                    years. Watch businesses flourish in the 1920s, then witness the devastating
                    impact of Nazi policies from 1933 onwards.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    <br />
                    Historical Research &amp; Data Compilation
                    <br />
                  ...
                  <p className="leading-relaxed mt-3">
                    ...
                    <br />
                    Interactive Visualization &amp; Web Development
                    <br />
                    <span className="text-sm" style={{ color: 'var(--foreground-muted)' }}>
                      Making history accessible through technology
                    </span>
                  </p>
                </div>
                ...
                <div className="pt-6 border-t" style={{ borderColor: 'var(--border)' }}>
                  <p className="text-sm" style={{ color: 'var(--foreground-muted)' }}>
                    For academic citations, please reference: Kreutzmüller, C. (2024). &quot;Jewish
                    Businesses in Berlin 1900-1945: A Digital Archive&quot;
                  </p>
                </div>
              </div>
            </div>
