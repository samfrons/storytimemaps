...
const ALL_PLAQUES = [
  { id: 1, name: 'Elias Braun - Tailor Shop', type: 'Tailoring', location: 'Rosenthaler Straße 40', years: '1925-1938' },
  { id: 2, name: 'Breslauer Brothers Department Store', type: 'Department Store', location: 'Unter den Linden 15', years: '1920-1935' },
  { id: 3, name: 'Deutsches Theater Café', type: 'Café', location: 'Schumannstraße 13a', years: '1928-1933' },
  { id: 4, name: 'Ebro Textiles', type: 'Textiles', location: 'Alexanderstraße 125', years: '1922-1939' },
  { id: 5, name: 'Hoxter & Sons Bookshop', type: 'Bookshop', location: 'Oranienburger Straße 28', years: '1910-1938' },
  { id: 6, name: 'Pelz Furrier', type: 'Furrier', location: 'Friedrichstraße 180', years: '1918-1937' },
  { id: 7, name: 'Product X Manufacturing', type: 'Manufacturing', location: 'Warschauer Straße 45', years: '1926-1936' },
  { id: 8, name: 'Eggs & Dairy Distributors', type: 'Food Distribution', location: 'Hackescher Markt 12', years: '1923-1935' },
  { id: 9, name: 'Jonas & Co. Law Firm', type: 'Law Practice', location: 'Neue Friedrichstraße 60', years: '1908-1933' },
  { id: 10, name: 'Kutschera Photography Studio', type: 'Photography', location: 'Potsdamer Straße 125', years: '1930-1938' },
  { id: 11, name: 'P. Kunst Gallery', type: 'Art Gallery', location: 'Unter den Linden 35', years: '1924-1937' },
  { id: 12, name: 'Ruilos Import Export', type: 'Import/Export', location: 'Spandauer Straße 15', years: '1921-1938' },
  { id: 13, name: 'Wassermann Medical Practice', type: 'Medical Practice', location: 'Rosenstraße 22', years: '1915-1938' },
  { id: 14, name: 'Butter & Fine Foods', type: 'Import/Export', location: 'Gendarmenmarkt 8', years: '1927-1936' },
  { id: 15, name: 'YVA Photography Agency', type: 'Photography', location: 'Kaiserdamm 118', years: '1925-1938' },
];
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="font-mono text-lg font-semibold" style={{ color: 'var(--foreground)' }}>
              StoryTimeMaps
            </span>
            <LanguageToggle />
          </div>
      ...
      <main className="pt-20">
        ...
        <section className="py-16 px-4" style={{ backgroundColor: 'rgba(var(--card-bg-rgb), 0.3)' }}>
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg font-mono max-w-2xl mx-auto" style={{ color: 'var(--foreground-muted)' }}>
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: hoveredPlaque === plaque.id ? '0 10px 30px rgba(0,0,0,0.2)' : 'none'
                    }}
                  >
                    {/* Plaque Image */}
                    <div className="aspect-[4/3] flex items-center justify-center p-4" style={{
                    ...
                    <div className="p-4" style={{ backgroundColor: 'var(--card-bg)' }}>
                      <h3 className="font-mono font-semibold mb-1 truncate" style={{ color: 'var(--foreground)' }}>
                        {plaque.name.split(' - ')[0]}
                      </h3>
                      <div className="flex items-center justify-between text-sm font-mono" style={{ color: 'var(--foreground-muted)' }}>
                        <span>{plaque.type}</span>
                        <span>{plaque.years}</span>
                      </div>
                      <p className="text-xs font-mono mt-2 truncate" style={{ color: 'var(--muted)' }}>
                        📍 {plaque.location}
                      </p>
                    </div>
                  </div>
        ...
        <section className="py-16 px-4" style={{ backgroundColor: 'var(--background)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Step 1 */}
              <div className="text-center p-6 border" style={{
                backgroundColor: 'rgba(var(--card-bg-rgb), 0.5)',
                borderColor: 'var(--border)'
              }}>
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center text-3xl" style={{
        ...
        <section className="py-16 px-4" style={{
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg font-mono max-w-3xl mx-auto mb-8" style={{ color: 'var(--foreground-muted)' }}>
              {t('plaques.partners.description')}
            </p>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
              <div className="p-4 border font-mono text-sm" style={{
        ...
        {/* Footer CTA */}
        <section className="py-16 px-4 text-center" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <footer className="py-8 px-4 border-t" style={{
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="font-mono text-sm transition-colors" style={{ color: 'var(--foreground-muted)' }}>
              {t('plaques.footer.map')}
            </Link>
            <Link href="/home" className="font-mono text-sm transition-colors" style={{ color: 'var(--foreground-muted)' }}>
