#!/usr/bin/env python3
"""
Enhanced cost-optimized scraper for HU Berlin Jewish Businesses Database
Extracts detailed business subcategories and registration information.
"""
...
class BusinessEntry:
    ...
    main_category: str = ""
    subcategory: str = ""
    detailed_subcategory: str = ""  # New: extracted from German text
    founded_year: Optional[str] = None
    closed_year: Optional[str] = None
    liquidation_date: Optional[str] = None  # New: specific liquidation dates
...
class EnhancedBusinessScraper:
    """Enhanced cost-optimized scraper with detailed extraction"""
    ...
    def __init__(self, cache_dir: str = './scrape_cache'):
        ...
        # Enhanced business categories mapping
    ...
    def extract_with_enhanced_patterns(self, soup_entry) -> BusinessEntry:
        """Enhanced pattern-based extraction with detailed subcategory extraction"""
        try:
            ...
            entry = BusinessEntry(
                ...
                raw_text=raw_text,
                confidence_score=0.9  # Higher confidence for enhanced extraction
            )
    ...
    def _extract_enhanced_categories(self, soup_entry, raw_text: str) -> tuple[str, str, str]:
        """Extract main category, subcategory, and detailed subcategory"""
    ...
    def _extract_enhanced_dates(self, text: str) -> tuple[Optional[str], Optional[str], Optional[str]]:
        """Enhanced date extraction with liquidation dates"""
        founded_year = None
        closed_year = None
    ...
    def _extract_enhanced_registration_info(self, raw_text: str) -> str:
        """Extract enhanced registration information"""
    ...
    def _extract_additional_details(self, raw_text: str) -> str:
        """Extract additional business details and context"""
    ...
    def scrape_page(self, url: str) -> List[BusinessEntry]:
        ...
        for entry in entries:
            ...
            if business.business_name and business.business_name != "EXTRACTION_FAILED":
                ...
                logger.info(f"Extracted: {business.business_name} ({business.detailed_subcategory})")
    ...
    def save_to_json(self, businesses: List[BusinessEntry], filename: str):
        ...
        output = {
            "metadata": {
                ...
                "pages_scraped": "1-10",
                "extraction_method": "Enhanced pattern-based with detailed subcategory extraction",
...
def main():
    ...
    logger.info("Starting enhanced Jewish businesses database scrape...")
    ...
    if all_businesses:
        # Save to JSON
        output_file = "/Users/samfrons/Desktop/storymaps/jewish_businesses_complete_enhanced.json"
        ...
        for i, business in enumerate(all_businesses[:3]):
            ...
            logger.info(f"  Registration: {business.registration_info}")
    else:
