...
const FEATURED_PLAQUES = [
  ...
  { id: 2, name: 'Breslauer Brothers', type: 'Department Store', location: 'Unter den Linden 15', years: '1920-1935' },
...
const PlaquesHero: React.FC<PlaquesHeroProps> = ({ showFullContent = true, compact = false }) => {
    ...
    return (
      <div className="p-6 border" style={{
        ...
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-16 h-16 flex items-center justify-center text-3xl" style={{
  ...
  return (
    <section className="py-16 px-4 relative overflow-hidden" style={{
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl opacity-10 transform rotate-45" style={{
        background: `linear-gradient(to bottom left, var(--danger), transparent)`
      }} />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr opacity-10" style={{
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 text-xs font-mono uppercase tracking-widest" style={{
            backgroundColor: 'var(--danger)',
            color: 'var(--background)'
          }}>
            <span>🏛️</span>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light mb-4" style={{
          ...
          <p className="text-xl md:text-2xl font-light max-w-3xl mx-auto mb-4" style={{
          ...
          <div className="w-56 h-1 mx-auto" style={{
        ...
        {showFullContent && (
          <>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-6">
                <div className="p-6 border-l-4" style={{
                  ...
                  <h2 className="text-xl font-semibold mb-3 font-mono" style={{ color: 'var(--foreground)' }}>
                ...
                <div className="p-6 border" style={{
                  ...
                  <h3 className="font-semibold mb-3 flex items-center gap-2 font-mono" style={{ color: 'var(--danger)' }}>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <h4 className="font-semibold mb-2 font-mono" style={{ color: 'var(--danger)' }}>
                        {t('plaques.hero.stolpersteineFocus')}:
                      </h4>
                      <ul className="space-y-1 font-mono" style={{ color: 'var(--foreground-muted)' }}>
                    ...
                    <div>
                      <h4 className="font-semibold mb-2 font-mono" style={{ color: 'var(--success)' }}>
              ...
              <div className="space-y-4">
                ...
                {/* Plaque Display */}
                <div className="relative aspect-[4/3] border shadow-lg flex items-center justify-center p-4" style={{
                ...
                <div className="grid grid-cols-3 gap-2">
                  {FEATURED_PLAQUES.map((plaque, index) => (
                    <button
                      ...
                      style={{
                        backgroundColor: selectedPlaque === index ? 'var(--primary)' : 'transparent',
                        color: selectedPlaque === index ? 'var(--background)' : 'var(--foreground-muted)',
            ...
            {/* Call to Action */}
            <div className="text-center p-8 border" style={{
              backgroundColor: 'rgba(var(--card-bg-rgb), 0.5)',
              borderColor: 'var(--border)'
            }}>
              ...
              <p className="mb-6 max-w-2xl mx-auto font-mono" style={{ color: 'var(--foreground-muted)' }}>
