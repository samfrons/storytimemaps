...
const MapboxMap = dynamic(() => import('../components/MapboxMap'), { 
  ...
  loading: () => (
    <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
      <div className="font-mono" style={{ color: 'var(--primary)' }}>Loading Frankfurt map...</div>
    </div>
  )
});
  ...
  useEffect(() => {
    const loadFrankfurtData = async () => {
      try {
        ...
        const response = await fetch('/frankfurt_businesses_complete.geojson')
          .catch(() => fetch('/frankfurt_businesses.geojson'));
    ...
    <div className="relative w-full h-screen overflow-hidden" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <div className="flex flex-col md:flex-row h-screen md:pl-16">
        ...
        <div className="flex-1 relative">
          ...
          {/* Time Slider */}
          <div className="absolute bottom-4 left-4 right-4 px-4 py-3 rounded" 
        ...
        <div className="relative h-full overflow-y-auto">
          <div className="p-8">
            ...
            <div className="space-y-8 pt-16 md:pt-0">
              <div>
                <h2 className="text-3xl font-light mb-2 font-['Space_Mono'] font-mono" style={{ color: 'var(--foreground)' }}>
              ...
              <div className="space-y-6 font-['Space_Mono'] font-mono" style={{ color: 'var(--foreground)' }}>
                <div>
                  ...
                  <p className="leading-relaxed">
                    This map displays Jewish-owned businesses in Frankfurt am Main as documented in the 1935 directory,
                    capturing the commercial landscape just before the implementation of the Nuremberg Laws.
                  </p>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2" style={{ color: 'var(--primary)' }}>Major Business Districts</h3>
                ...
                <div className="pt-6 border-t" style={{ borderColor: 'var(--border)' }}>
                  <p className="text-sm" style={{ color: 'var(--foreground-muted)' }}>
                    Data extracted from the 1935 Frankfurt Jewish Business Directory. 
                    This visualization serves as a memorial to the destroyed Jewish commercial life of Frankfurt.
                  </p>
                </div>
              </div>
            </div>
