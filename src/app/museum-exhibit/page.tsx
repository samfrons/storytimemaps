...
function MuseumExhibitContent() {
  ...
  // Handle language change. toggleLanguage cycles de -> en -> yi when called with no
  // argument, so the requested language is passed explicitly: this kiosk offers German
  // and English only, and a bare toggle would land visitors on Yiddish.
