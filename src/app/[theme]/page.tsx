  ...
  return (
    <div className="relative w-full h-screen overflow-hidden" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <div className="flex flex-col md:flex-row h-screen">
          ...
          <div className="hidden md:flex md:w-16 md:h-full flex-shrink-0 flex-col items-center py-6 gap-4 relative backdrop-blur-sm hot-sidebar" 
            ...
            <button
              ...
              className={`w-10 h-10 flex items-center justify-center transition-all duration-200 border relative hot-button ${showThemeMenu ? 'hot-button-active' : ''}`}
              style={{
              ...
              <div className="absolute top-16 left-0 border backdrop-blur-sm shadow-lg p-2 min-w-[120px] hot-dropdown" 
                ...
                {['moody', 'bauhaus', 'cool', 'warm', 'hot', 'cold', 'art-nouveau'].map((themeName) => (
                  <button
                    ...
                    className={`w-full px-3 py-2 text-left text-xs font-mono transition-colors capitalize hover:opacity-80 ${currentTheme === themeName ? 'dropdown-active' : ''}`}
                    style={{
                      backgroundColor: currentTheme === themeName ? 'var(--primary)' : 'transparent',
                      color: currentTheme === themeName ? 'var(--background)' : 'var(--foreground)'
                    }}
                  >
            ...
            <button
              onClick={goHome}
              className={`w-10 h-10 flex items-center justify-center transition-all duration-200 border hover:opacity-80 hot-button ${showIntro ? 'hot-button-active' : ''}`}
              style={{
            ...
            <button
              onClick={toggleInfo}
              className={`w-10 h-10 flex items-center justify-center transition-all duration-200 border hover:opacity-80 hot-button ${showInfo ? 'hot-button-active' : ''}`}
              style={{
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 w-10 h-10 flex items-center justify-center border backdrop-blur-sm hot-button"
        style={{ 
          zIndex: 10001,
          backgroundColor: 'var(--input-bg)',
          borderColor: 'var(--border)',
      ...
      {showMobileMenu && (
        <div className="md:hidden fixed top-16 left-4 border backdrop-blur-sm shadow-lg p-2 flex flex-col gap-2 hot-dropdown" 
          ...
          <button
            ...
            className={`w-12 h-12 flex items-center justify-center transition-all duration-200 border hover:opacity-80 hot-button ${showIntro ? 'hot-button-active' : ''}`}
            style={{
              backgroundColor: showIntro ? 'var(--primary)' : 'var(--input-bg)',
              borderColor: 'var(--border)',
              color: showIntro ? 'var(--background)' : 'var(--foreground)'
          ...
          <button
            ...
            className={`w-12 h-12 flex items-center justify-center transition-all duration-200 border hover:opacity-80 hot-button ${showInfo ? 'hot-button-active' : ''}`}
            style={{
              backgroundColor: showInfo ? 'var(--primary)' : 'var(--input-bg)',
              borderColor: 'var(--border)',
              color: showInfo ? 'var(--background)' : 'var(--foreground)'
