...
const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, story, currentDate }) => {
  ...
  const copyToClipboard = React.useCallback(
    async (type: 'link' | 'instagram') => {
      try {
        const textToCopy =
          type === 'instagram' ? `${getShareText()}\n\n${getShareUrl()}` : getShareUrl()
    ...
    return [
      {
        ...
        description: t('share.copyLinkDesc', {
          ns: 'common',
          defaultValue: 'Copy the link to clipboard',
        }),
        icon: (
      ...
      },
      {
        ...
        action: () => {
          window.open(
            `mailto:?subject=${encodeURIComponent(emailContent.subject)}&body=${encodeURIComponent(emailContent.body)}`,
            '_blank'
          )
        },
      },
      ...
      },
      {
        ...
        description: t('share.instagramDesc', {
          ns: 'common',
          defaultValue: 'Copy text for Instagram',
        }),
        icon: (
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        ...
        {story && (
          <div className="p-4 border-b" style={{ borderColor: 'var(--border)' }}>
            <p className="font-mono text-sm font-semibold mb-1" style={{ color: 'var(--primary)' }}>
              {story.title}
            </p>
            {story.address && (
          ...
          {supportsNativeShare && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-mono text-xs" style={{ color: 'var(--foreground-muted)' }}>
                  {t('share.shareViaDesc', {
                    ns: 'common',
                    defaultValue: 'Use system share options',
                  })}
                </p>
              </div>
            </button>
        ...
        <div className="p-4 border-t" style={{ borderColor: 'var(--border)' }}>
          <p className="font-mono text-xs mb-2" style={{ color: 'var(--foreground-muted)' }}>
